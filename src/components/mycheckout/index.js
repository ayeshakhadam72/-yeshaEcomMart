   ...
   
{
    basket.map((b) => {
        return(
            <>
             <div  className='  flex gap-8 items-center border-b-[1px] border-gray-200 pb-10 pt-10 '>
             <div className='relative'> 
            <span className='bg-white border-gray-200 border-[1px] px-2  absolute rounded-full left-[85%] mt-[-16px] '> 1 </span>
                <Image src={b.productimage} className='w-[100px] h-[100px] object-cover shadow-lg' />
            </div>
           <div className=''>
...
{/* second step 2*/}
<div  className='py-10 mt-10  border-b-[1px]  border-gray-200'>
    <div className=''>
   <div>
  <h2 className='text-xl font-semibold text-center pb-8'> Choose More  </h2>
  </div>
...
{/* step3 */}
 <div className='py-10   border-b-[1px]  border-gray-200'>
