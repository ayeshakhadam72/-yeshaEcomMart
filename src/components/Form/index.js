      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1">
          <div className="lg:mb-0 mb-10">
            <div className="group w-full h-full">
              <div className="relative h-full">
                <Image src={ContactImage} alt="ContactUs tailwind section" className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700 object-cover" />
          ...
          <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
            <h2 className="text-black uppercase font-manrope text-4xl font-semibold leading-10 mb-11">Send Us A Message</h2>
            ...
            <textarea rows={8} type="text" className="w-full  text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm rounded-lg border border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Message" />
