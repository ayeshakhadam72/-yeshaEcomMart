...
<div className=' sm:flex  gap-10'>
    <div className='pt-7 sm:pt-0'>
        <h2 className="text-4xl text-blue-600 font-semibold">12</h2>
        <h2 className="text-sm text-black">Years Experience</h2>
    </div>
    <div className='pt-7 sm:pt-0'>
    <h2 className="text-4xl text-blue-600 font-semibold">20K</h2>
    <h2 className="text-sm text-black">Happy Customers</h2>
    </div>
    <div className='pt-7 sm:pt-0'>
    <h2 className="text-4xl text-blue-600 font-semibold">100%</h2>
