...
<div className=' text-center lg:flex  lg:justify-between border-b-[1px] border-gray-200  w-[100%]  pb-1'>
    
    <div className='sm:text-[50px] md:text-[70px ] text-[#1c1c24] font-title font-[500]'> 
        <h2>Best Deals</h2>
    </div>
    {/*  */}
...
<div className='sm:flex flex-wrap justify-around '>
    ...
    {
        Productdata.slice(1,5).map((b) =>{
            return(
                <AgainreuseProduct image2 ={b.productimage } space={'py-2  '} border={'border-b-[1px] sm:border-b-0 sm:border-r-[1px] border-gray-200 text-center '}  heading = {b.productname}  pricenew={b.productprice} Addproduct={Addproduct} b={b} />
